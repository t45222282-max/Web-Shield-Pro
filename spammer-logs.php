...
<?php if (!empty($settings['ui_engine']) && $settings['ui_engine'] === 'shield'): ?>
    <header class="shield-page-header">
        <div class="shield-page-header__main">
            <h1 class="txt-h1">سجلات المزعجين</h1>
            <p class="txt-body-sm txt-secondary">مراقبة الزيارات والتعليقات المزعجة (Spam) التي تم حظرها.</p>
        </div>
...
<div class="content-header">
	...
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 "><i class="fas fa-align-justify"></i> سجلات المزعجين</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> لوحة الإدارة</a></li>
					<li class="breadcrumb-item active">سجلات المزعجين</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="container-fluid">
	...
	<div class="col-md-12">
		...
		<div class="shield-card">
			<div class="shield-card">
				<h3 class="shield-card">سجلات المزعجين</h3>&nbsp;&nbsp;&nbsp;
				<a href="?delete-all" class="btn btn-flat btn-danger btn-sm float-sm-right" data-toggle="tooltip" title="حذف جميع سجلات المزعجين"><i class="fas fa-trash"></i> حذف الكل</a>
			</div>
			<div class="shield-card">
