...
<?php if (!empty($settings['ui_engine']) && $settings['ui_engine'] === 'shield'): ?>
    <header class="shield-page-header">
        <div class="shield-page-header__main">
            <h1 class="txt-h1">سجلات الروبوتات الضارة</h1>
            <p class="txt-body-sm txt-secondary">مراقبة الروبوتات الخبيثة والزيارات المشبوهة التي تم حظرها.</p>
        </div>
        ...
        while ($row = mysqli_fetch_assoc($sql)) {
            echo '
                <tr>
                  ...
                  <td data-label="النوع"><i data-lucide="bot-off" class="icon icon-sm text-critical"></i> ' . $row['type'] . '</td>
                  ...
                  <td data-label="User-Agent">' . $row['useragent'] . '</td>
                </tr>
        ';
        }
        ?>
...
<div class="content-header">
	...
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 "><i class="fas fa-align-justify"></i> سجلات الروبوتات الضارة</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="dashboard.php"><i class="fas fa-home"></i> لوحة الإدارة</a></li>
					<li class="breadcrumb-item active">سجلات الروبوتات الضارة</li>
				</ol>
			</div>
		</div>
	</div>
...
<div class="container-fluid">
	...
	<div class="col-md-12">
		...
		<div class="shield-card">
			<div class="shield-card">
				<h3 class="shield-card">سجلات الروبوتات الضارة</h3>&nbsp;&nbsp;&nbsp;
				<a href="?delete-all" class="btn btn-flat btn-danger btn-sm float-sm-right" data-toggle="tooltip" title="حذف جميع سجلات الروبوتات الضارة"><i class="fas fa-trash"></i> حذف الكل</a>
			</div>
			<div class="shield-card">
