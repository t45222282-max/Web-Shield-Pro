...
<?php if (!empty($settings['ui_engine']) && $settings['ui_engine'] === 'shield'): ?>
    <header class="shield-page-header">
        <div class="shield-page-header__main">
            <h1 class="txt-h1">سجلات هجمات SQL</h1>
            <p class="txt-body-sm txt-secondary">مراقبة محاولات حقن قواعد البيانات (SQL Injection).</p>
        </div>
        ...
        while ($row = mysqli_fetch_assoc($sql)) {
            echo '
                <tr>
                  ...
                  <td data-label="الصفحة">' . $row['page'] . '?' . $row['query'] . '</td>
                </tr>
        ';
        }
        ?>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            ...
            <div class="shield-card">
                <div class="shield-card">
                    <h3 class="shield-card">سجلات هجمات SQL</h3>&nbsp;&nbsp;&nbsp;
