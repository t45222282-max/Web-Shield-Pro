...
<head>
    ...
    <!-- Switchery -->
    <link href="assets/offline/css/switchery.min.css" rel="stylesheet">
    <script src="https://cdnjs.cloudflare.com/ajax/libs/switchery/0.8.2/switchery.min.js"></script>
    
    <!-- Select2 -->
    <link href="assets/offline/css/select2.min.css" rel="stylesheet">
...
<?php
    if (basename($_SERVER['SCRIPT_NAME']) == 'dashboard.php' || basename($_SERVER['SCRIPT_NAME']) == 'visit-analytics.php') {
        echo '
    <!--Chart.js-->
    <script src="assets/offline/js/chart.min.js"></script>';
        if (!empty($settings['ui_engine']) && $settings['ui_engine'] === 'shield') {
            echo '
    <script src="assets/js/shield/charts-defaults.js"></script>';
        }
    }
?>
...
<div id="cyber-bg" aria-hidden="true">
    <div class="cyber-bg__image"></div>
    <div class="cyber-binary-rain"></div>
    <div class="cyber-bg__overlay"></div>
</div>
<?php include 'includes/shield-sidebar.php'; ?>
<?php include 'includes/shield-topbar.php'; ?>
<?php endif; ?>
...
<?php if (!empty($settings['ui_engine']) && $settings['ui_engine'] === 'shield'): ?>
    <?php include 'includes/shield-command-palette.php'; ?>
    <!-- Lucide Icons -->
    <script src="https://unpkg.com/lucide@latest"></script>
    <!-- Shield UI Engine -->
    <script src="assets/js/shield/shield-ui.js"></script>
<?php endif; ?>
