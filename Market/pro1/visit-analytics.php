            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title">تحليلات الزيارات</h3>&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="card-body">
                        ...
                        <br /><h4 class="card-title">إحصائيات هذا الشهر</h4><br />
                        ...
                        <br /><h4 class="card-title">الزيارات لهذا الشهر</h4><br />
                        
                            <canvas id="visits-chart"></canvas>
                            
                        <br /><h4 class="card-title">الإحصائيات العامة</h4><br />    
