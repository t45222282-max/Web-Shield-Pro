...
<body>
    ...
    <div class="banned-container">
        <span class="banned-icon fa-stack fa-2x">
        ...
        if ($cid > 0) {
            ...
            $banned      = $querybanned->num_rows;
            $rowcb       = $querybanned->fetch_assoc();
            $redirect    = $rowcb['redirect'];
            $url         = $rowcb['url'];
            if ($redirect == 1) {
                echo '<p>سيتم إعادة توجيهك خلال 4 ثوانٍ.</p>';
