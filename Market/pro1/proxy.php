...
?>
    <div class="card-header">
        <h3 class="card-title">بروكسي - وحدة الحماية</h3>
    </div>
    <div class="card-body">
<?php
if ($settings['proxy_protection'] > 0 OR $settings['proxy_protection2'] == 1) {
...
?>
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            <h3 class="card-title"><i class="fas fa-shield-alt"></i> طرق كشف البروكسي</h3>
        </div>
        <div class="card-body">
...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h3 class="card-title"><i class="fas fa-info-circle"></i> ما هو البروكسي؟</h3>
    </div>
    <div class="card-body">
