				...
				<div class="col-md-8">
								...
								<div class="tab-content">
									<div id="f1" class="tab-pane fade active show">
									    <div class="card card-body bg-light">تنفيذ الأوامر وإرجاع الناتج الكامل</div><br />
										    <div class="callout callout-default">
									    		<h6><i class="fas fa-code"></i> exec &nbsp;&nbsp;
<?php
if (function_exists('exec')) {
    echo '<span class="badge badge-danger">غير معطل</span>';
} else {
    echo '<span class="badge badge-success">معطل</span>';
}
?>
...
?>
									...
									<div id="f2" class="tab-pane fade">
										<div class="card card-body bg-light">بخلاف eval، هناك طرق أخرى لتنفيذ كود PHP: يمكن استخدام include/require لتنفيذ كود عن بُعد في شكل ثغرات تضمين الملفات المحلية والعن بُعد.</div><br />
											<div class="callout callout-default">
...
?>                                                
									...
									<div id="f3" class="tab-pane fade">
									    <div class="card card-body bg-light">معظم استدعاءات هذه الدوال ليست نقاط ضعف مباشرة، ولكن قد تكون ثغرة إذا كان أي من البيانات المُرجعة مرئيًا للمهاجم.</div><br />
											<div class="callout callout-default">
...
if (function_exists('display_errors')) {
    echo '<span class="badge badge-warning">غير معطل</span>';
} else {
    echo '<span class="badge badge-success">معطل</span>';
}
?>                                                
...
?>                                                
				...
				<div class="col-md-4">
				     <div class="card">
						<div class="card-header">
							<h3 class="card-title"><i class="fas fa-info-circle"></i> معلومات ونصائح</h3>
						</div>
				        <div class="card-body">
                     ...
                     <div class="card">
						<div class="card-header">
							<h3 class="card-title"><i class="fab fa-php"></i> كيفية تعطيل دوال PHP</h3>
						</div>
				        <div class="card-body">
							  <ol>
