...
?>
            <center><h6>يرجى تقديم المعلومات التالية. لا داعي للقلق، يمكنك دائمًا تغيير هذه الإعدادات لاحقًا</h6></center><hr />
            <form method="post" action="" class="form-horizontal row-border">
                        
				<div class="form-group row">
					<p class="col-sm-3">اسم المستخدم: </p>
					<div class="col-sm-8">
...
?>" required>
				...
				<div class="form-group row">
					<p class="col-sm-3">كلمة المرور: </p>
					<div class="col-sm-8">
                        <div class="input-group">
							<div class="input-group-text">
...
?>
					<br /><div class="row">
	                    <div class="col-md-6">
							<a href="index.php" class="btn-secondary btn col-12"><i class="fas fa-arrow-left"></i> رجوع</a>
						</div>
						<div class="col-md-6">
							<input class="btn-primary btn col-12" type="submit" name="submit" value="التالي" />
						</div>
					</div><br />
