...
<head>
    ...
    <style>
        ...
        .dark-mode .blocked-container h1 {
            color: #e5e7eb;
        }
        .blocked-container p {
            font-size: 1.2rem;
