...
<div class="shield-table-wrapper">
    ...
    if ($row['type'] == 'SQLi') {
        echo '
            <i data-lucide="database-zap" class="icon icon-sm text-brand"></i> ' . $row['type'] . '
            ';
    } else if ($row['type'] == 'Proxy') {
        echo '
            <i data-lucide="globe-lock" class="icon icon-sm text-success"></i> ' . $row['type'] . ' 
            ';
    } else if ($row['type'] == 'Spammer') {
        echo '
            <i data-lucide="mail-x" class="icon icon-sm text-warning"></i> ' . $row['type'] . '
            ';
    } else {
        echo '
            <i data-lucide="bot-off" class="icon icon-sm text-critical"></i> ' . $row['type'] . '
            ';
    }
    echo '
          </td>
